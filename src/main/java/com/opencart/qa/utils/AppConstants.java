...
public class AppConstants {
	...
	public static final String HOME_PAGE_URL = "route=account/account";

	public static final List<String> EXP_HEADERS_LIST = Arrays.asList("My Account", "My Orders", "My Affiliate Account","Newsletter");

	public static final String ADD_TO_CART_SUCESS_MSG = "Success: You have added ";
	
	public static final String REGISTER_SUCESS_MSG = "Your Account Has Been Created!";

...
public class ElementUtil {
	...
	@Step("clicking on element using by locator: {0} and the timeout{1}")
	...
	@Step("get text attribute of the element using by locator: {0}")
	...
	@Step("find element using by locator: {0} and timeout : {1}")
	...
	@Step("number of find elements using by locator: {0}")
	public List<WebElement> getElements(By locator) {
		return driver.findElements(locator);
	}

	@Step("get the text from the list of web Element using by locator : {0}")
	...
	@Step("get the count from the list of element using by locator : {0}")
	...
	@Step("click on the action element using by locator : {0} ")
	public void doActionsClick(By locator) {
		act.click(getElement(locator)).perform();
	}

	@Step("enter the value {1} action element using by locator : {0} ")
	 ...
	 * @return
	 */
	@Step("waiting for the lis of elements to be Presence : {0} with timeout {1}")
	 ...
	 * @return
	 */
	@Step("waiting for the list elements to be visible : {0} with timeout {1}")
	...
	@Step("waiting for the element to be click : {0} with timeout {1}")
	...
	@Step("waiting for the lis of elements to be visible : {0} with timeout {1}")
